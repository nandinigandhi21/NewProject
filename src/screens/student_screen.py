...
def student_dashboard():
    ...
    with c2:
        if st.button('Enroll in Subject', type = 'primary', widht = 'stretch'):
            enroll_dialog()
...
def student_screen():
    ...
    if show_registration:
        with st.container(border = True):
            ...
            new_name = st.text_input("Enter your name", placeholder = 'Eg. Siya Baweja')
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, My name is Siya.')
